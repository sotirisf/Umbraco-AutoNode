namespace DotSee
{
    ...
    public class AutoNodeRule
    {
        ...
        public AutoNodeRule(string createdDocTypealias, string docTypeAliasToCreate, string nodeName, bool bringNodeFirst = false, bool onlyCreateIfNoChildren = false, bool createIfExistsWithDifferentName=true)
        {
